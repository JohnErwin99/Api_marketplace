...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" xmlns:urn="${ns}">
  <soapenv:Header>
...
async function call(method, innerXml, creds, env = 'test') {
  if (!creds || !creds.username || !creds.password) {
    throw new AppError(401, 'missing_credentials', 'No Espresso credentials provided');
  }
  const endpoint = ENDPOINTS[env] || ENDPOINTS.test;
